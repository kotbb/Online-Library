document.addEventListener('DOMContentLoaded', function() {
    ...
    searchInput.addEventListener('input', function() {
        ...
        if (searchTerm === '') {
            console.log('Empty search term, resetting search');
            resetSearch();
        } else {
            debouncedSearch();
        }
    ...
    function performSearch() {document.addEventListener('DOMContentLoaded', function() {
        // DOM Elements
        const searchInput = document.getElementById('searchInput');
        const searchButton = document.querySelector('.search-box .btn-primary');
        const booksContainer = document.getElementById('booksContainer');
        ...
        const searchTerm = searchInput.value.toLowerCase().trim();
        console.log('Perform search called, search term:', searchTerm);
        
        if (searchTerm === '') {
            console.log('Empty search term in performSearch, calling resetSearch');
            resetSearch();
            return;
        }
        ...
        console.log('Search complete, found books:', foundBooks, 'visible count:', visibleCount);
    ...
    function resetSearch() {
        ...
        // Only show notification and clear input if this was triggered by user action
        // not when the function is called internally
        const wasSearchActive = searchInput.value.trim() !== '';
        if (wasSearchActive) {
            showNotification('Showing all books', 'info');
            searchInput.value = '';
        }
        
        console.log('Reset search called, showing all books');
    }
